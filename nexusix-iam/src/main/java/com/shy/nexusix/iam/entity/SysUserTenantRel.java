...
public class SysUserTenantRel implements Serializable {
    ...
    @Schema(description = "主部门 ID (必须属于当前租户)", example = "1001")
    @TableField(value = "dept_id")
    private Long deptId;

    @Schema(description = "是否租户管理员(解决一个人在 A 公司是管理员、在 B 公司是普通员工，is_admin不等于角色)", example = "false")
    @TableField(value = "is_admin")
    private Boolean isAdmin;

    @Schema(description = "加入时间", format = "date-time", example = "2026-04-07 15:45:30")
