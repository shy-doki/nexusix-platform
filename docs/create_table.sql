...
COMMENT ON COLUMN sys_permission.perm_code IS '权限标识';
COMMENT ON COLUMN sys_permission.perm_type IS '类型';
...
COMMENT ON COLUMN sys_permission_policy.id IS '主键ID';
COMMENT ON COLUMN sys_permission_policy.target_type IS '目标类型';
COMMENT ON COLUMN sys_permission_policy.target_id IS '目标ID';
COMMENT ON COLUMN sys_permission_policy.target_name IS '目标名称';
COMMENT ON COLUMN sys_permission_policy.permission_id IS '关联权限ID';
COMMENT ON COLUMN sys_permission_policy.perm_name IS '关联权限名称';
COMMENT ON COLUMN sys_permission_policy.action IS '动作';
COMMENT ON COLUMN sys_permission_policy.priority IS '优先级';
COMMENT ON COLUMN sys_permission_policy.inheritance_enabled IS '是否向下继承';
COMMENT ON COLUMN sys_permission_policy.create_by IS '创建人ID';
COMMENT ON COLUMN sys_permission_policy.create_by_name IS '创建人名称';
COMMENT ON COLUMN sys_permission_policy.update_by IS '更新人ID';
