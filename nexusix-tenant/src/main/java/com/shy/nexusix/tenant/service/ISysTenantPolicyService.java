...
public interface ISysTenantPolicyService extends IService<SysTenantPolicy> {
     ...
     * @return 修改结果行数
     * @throws com.shy.nexusix.common.exception.BusinessException 当用户无权限或策略不存在或修改失败时抛出
     * @author shy
     * @since 2026-06-13
     */
     ...
     * @param status 策略状态
     * @return 更新结果行数
     * @throws com.shy.nexusix.common.exception.BusinessException 当用户无权限或策略不存在或更新失败时抛出
     * @author shy
     * @since 2026-06-13
     */
     ...
     * @param policyCode 策略编码
     * @return 删除结果行数
     * @throws com.shy.nexusix.common.exception.BusinessException 当用户无权限或策略不存在或删除失败时抛出
     * @author shy
     * @since 2026-06-13
     */
