...
public interface SysTenantConverter {
    ...
    default void filterTreeVoByVisibleFields(SysTenantTreeVO vo, List<String> visibleFields) {
        ...
        if (!visibleFieldSet.contains("tenantAddress")) vo.setTenantAddress(null);
        if (!visibleFieldSet.contains("tenantDesc")) vo.setTenantDesc(null);
        if (!visibleFieldSet.contains("tenantScale")) vo.setTenantScale(null);
        if (!visibleFieldSet.contains("tenantLogoUrl")) vo.setTenantLogoUrl(null);
        if (!visibleFieldSet.contains("inviteCode")) vo.setInviteCode(null);
        if (!visibleFieldSet.contains("parentId")) vo.setParentId(null);
        if (!visibleFieldSet.contains("level")) vo.setLevel(null);
        ...
        if (!visibleFieldSet.contains("contactEmail")) vo.setContactEmail(null);
        ...
        if (!visibleFieldSet.contains("packageId")) vo.setPackageId(null);
