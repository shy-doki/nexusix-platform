...
//        return stringRedisTemplate.opsForValue().get(GlobalConstant.RedisKey.SA_TOKEN_PREFIX + key);
//    }
//
//    /**
//     * <p>
...
//        if (timeout == -1) {
//            stringRedisTemplate.opsForValue().set(GlobalConstant.RedisKey.SA_TOKEN_PREFIX + key, value);
//        } else {
//            stringRedisTemplate.opsForValue().set(GlobalConstant.RedisKey.SA_TOKEN_PREFIX + key, value, timeout, TimeUnit.SECONDS);
//        }
//    }
//
//    /**
...
//        // 获取当前键的剩余存活时间
//        String redisKey = GlobalConstant.RedisKey.SA_TOKEN_PREFIX + key;
...
//        stringRedisTemplate.delete(GlobalConstant.RedisKey.SA_TOKEN_PREFIX + key);
//    }
//
//    /**
//     * <p>
...
//        Long ttl = stringRedisTemplate.getExpire(GlobalConstant.RedisKey.SA_TOKEN_PREFIX + key, TimeUnit.SECONDS);
...
//        String json = stringRedisTemplate.opsForValue().get(GlobalConstant.RedisKey.SA_TOKEN_PREFIX + key);
//        if (json == null) {
//            return null;
//        }
...
//        if (timeout == -1) {
//            stringRedisTemplate.opsForValue().set(GlobalConstant.RedisKey.SA_TOKEN_PREFIX + key, json);
//        } else {
//            stringRedisTemplate.opsForValue().set(GlobalConstant.RedisKey.SA_TOKEN_PREFIX + key, json, timeout, TimeUnit.SECONDS);
//        }
//    }
//
//    /**
...
//        String pattern = GlobalConstant.RedisKey.SA_TOKEN_PREFIX + prefix + "*" + keyword + "*";
//
//        // 执行模糊匹配查询
...
//                .map(k -> k.substring(GlobalConstant.RedisKey.SA_TOKEN_PREFIX.length()))
