...
@TableName("sys_dept")
@Schema(name="SysDept对象", description="部门表 - 存储租户组织架构，支持无限层级")
public class SysDept implements Serializable {
    ...
    @Schema(description = "祖级列表 (物化路径)", example = "0,100,200")
    ...
    @Schema(description = "部门负责人 ID", example = "1987654321098765432")
